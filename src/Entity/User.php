...
class User implements UserInterface
{
     ...
     * @Assert\Email(
     *  message = "L'entrée {{ value }} n'est pas un mail valide, veuillez resaisir un mail valid")
     */
    private $email;
     ...
     * @Assert\Length(min=8, minMessage="saisir plus de 8 char.")
     */
    private $password;
